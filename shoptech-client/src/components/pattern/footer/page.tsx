...
const Footer = () => {
  return (
    <div className="w-full min-h-200 bg-white mt-30 mb-40">
        ...
        <div className="flex flex-wrap w-full md:flex-nowrap lg:flex-nowrap xl:flex-nowrap">
          <div className='w-1/2 md:mr-2 md:w-1/4 lg:w-1/4 xl:w-1/4'>
            <div className='block w-full text-sm pb-6 pl-4'>
              <label className='text-xs font-bold block mb-2 mt-2 md:text-md md:mb-4 md:mt-8'>Tìm chi nhánh cửa hàng ShopTECH</label>
              <iframe
            ...
            <div className='block w-full text-sm pb-6 pl-4'>
              <label className='text-xs font-bold block mb-2 mt-2 md:text-md md:mb-4 md:mt-8'>Những phương thức thanh toán</label>
              <img
          ...
          <div className='w-1/2 md:mr-2 md:w-1/4 lg:w-1/4 xl:w-1/4'>
            <div className='block w-full text-sm pb-6 pl-4'>
              <label className='text-xs font-bold block mb-2 mt-2 md:text-md md:mb-4 md:mt-8'>Thông tin, chính sách và điều khoản sử dụng</label>
              <a href='/policy' className='block decoration-none text-sm text-gray-700 my-2 py-2'>Mua hàng và thanh toán</a>
              <a href='/policy' className='block decoration-none text-sm text-gray-700 my-2 py-2'>Mua trả góp sản phẩm</a>
              <a href='/policy' className='block decoration-none text-sm text-gray-700 my-2 py-2'>Tra cứu thông tin đơn hàng</a>
              <a href='/policy' className='block decoration-none text-sm text-gray-700 my-2 py-2'>Tra cứu ưu đãi</a>
              <a href='/policy' className='block decoration-none text-sm text-gray-700 my-2 py-2'>Tra cứu thông tin bảo hành</a>
              <a href='/policy' className='block decoration-none text-sm text-gray-700 my-2 py-2'>Tra cứu hóa đơn điện tử</a>
              <a href='/policy' className='block decoration-none text-sm text-gray-700 my-2 py-2'>Chính sách bảo hành</a>
              <a href='/policy' className='block decoration-none text-sm text-gray-700 my-2 py-2'>Chính sách hậu mãi</a>
              <a href='/policy' className='block decoration-none text-sm text-gray-700 my-2 py-2'>Điều khoản sử dụng</a>
          ...
          <div className='w-1/2 md:mr-2 md:w-1/4 lg:w-1/4 xl:w-1/4'>
            <div className='block w-full text-sm pb-6 pl-4'>
              <label className='text-xs font-bold block mb-2 mt-2 md:text-md md:mb-4 md:mt-8'>Tổng đài viên hỗ trợ 24/7 <span className='font-semibold text-red-500'>(Miễn phí tư vấn)</span></label>
              <div className='block decoration-none text-sm text-gray-700 my-4 py-2'>
                <p className='inline w-full mr-4'>Hỗ trợ mua hàng:</p>
                <span className='inline font-semibold text-blue-600 pr-4'>1800 3234</span>
                <span className='hidden md:block md:inline lg:block lg:inline xl:block xl:inline'>(24/7)</span>
              </div>
              <div className='block decoration-none text-sm text-gray-700 my-4 py-2'>
                <p className='inline w-full mr-4'>Hỗ trợ kỹ thuật:</p>
                <span className='inline font-semibold text-blue-600 pr-4'>1800 1234</span>
                <span className='hidden md:block md:inline lg:block lg:inline xl:block xl:inline'>(Giờ hành chính)</span>
              </div>
              <div className='block decoration-none text-sm text-gray-700 my-4 py-2'>
                <p className='inline w-full mr-4'>Giải quyết khiếu nại:</p>
                <span className='inline font-semibold text-blue-600 pr-4'>1800 4321</span>
                <span className='hidden md:block md:inline lg:block lg:inline xl:block xl:inline'>(24/7)</span>
              </div>
              <div className='block decoration-none text-sm text-gray-700 my-4 py-2'>
                <p className='inline w-full mr-4'>Bảo hành sản phẩm:</p>
                <span className='inline font-semibold text-blue-600 pr-4'>1800 3234</span>
                <span className='hidden md:block md:inline lg:block lg:inline xl:block xl:inline'>(Giờ hành chính)</span>
              </div>
              <div className='block decoration-none text-sm text-gray-700 my-4 py-2'>
                <p className='inline w-full mr-4'>Vấn đề khác:</p>
                <span className='inline font-semibold text-blue-600 pr-4'>1800 3234</span>
                <span className='hidden md:block md:inline lg:block lg:inline xl:block xl:inline'>(Giờ hành chính)</span>
              </div>
            </div>
          ...
          <div className='w-1/2 md:mr-2 md:w-1/4 lg:w-1/4 xl:w-1/4'>
            <div className='block w-full text-sm pb-6 pl-4'>
              <label className='text-xs font-bold block mb-2 mt-2 md:text-md md:mb-4 md:mt-8'>KẾT NỐI VỚI CHÚNG TÔI - ShopTECH BESIDE YOU</label>
            ...
            <div className='block w-full text-sm pb-6 pl-4'>
              <label className='text-xs font-bold block mb-2 mt-2 md:text-md md:mb-4 md:mt-8' style={{ width: "100%" }}>Chứng nhận</label>
